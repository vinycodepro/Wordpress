        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr>
                    <th>Logo</th>
                    <td>
                        <input type="text" id="theme_logo" name="theme_logo"
                               value="<?php echo esc_attr(get_option('theme_logo')); ?>">
                        <button type="button" class="button upload-logo">Upload</button>
                    </td>
                </tr>
                ...
                <tr>
                    <th>Address</th>
                    <td>
                        <textarea name="address_info"><?php
                            echo esc_textarea(get_option('address_info'));
                        ?></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="url" name="facebook_link"
                               value="<?php echo esc_url(get_option('facebook_link')); ?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="url" name="twitter_link"
                               value="<?php echo esc_url(get_option('twitter_link')); ?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="url" name="instagram_link"
                               value="<?php echo esc_url(get_option('instagram_link')); ?>">
                    </td>
                </tr>
            </table>
...
function theme_register_settings() {
    ...
    register_setting('theme_settings_group', 'fax_number');
    register_setting('theme_settings_group', 'address_info');
    register_setting('theme_settings_group', 'facebook_link');
    register_setting('theme_settings_group', 'twitter_link');
    register_setting('theme_settings_group', 'instagram_link');
}
...
add_action('init', function () {
    error_log( print_r( get_option('phone_number'), true ) );
});

function get_hompage() {
	get_template_part('hompage');
}